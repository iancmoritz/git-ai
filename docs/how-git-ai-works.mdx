...
We've profiled the extension and found the overhead to be about 10-20ms per command -- most of it in spawning the git process. See the [extension implementation](https://github.com/acunniffe/git-ai?tab=readme-ov-file#install):
