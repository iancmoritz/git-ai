...
| `share_prompts_in_repositories` | `Pattern[]` | Share prompts in authorship logs only for repositories matching these patterns. Supports glob patterns (e.g., `https://github.com/myorg/*`) | Empty list (prompts not shared by default as of v1.0.24) |
